# -*- coding: utf-8 -*-
"""
Created on Tue Apr 10 23:03:54 2018
   ...
   for x in content:
      ...
      if(update_frequency and not x.startswith("}") and x !="" and "{" not in x):  
          ...
          try:         
            ...
            print("Frequency is string:"+str(frequency)+":")
...
def displayResults():
   for nodename in _NODENAME2NODENAMEOBJECT:
       ...
       print("		Level Value: "+str(nodeobject.getBottom()))
...
def computePower_Energy():
    ...
    for nodename in _NODENAME2NODENAMEOBJECT:
        nodeobject =  _NODENAME2NODENAMEOBJECT[nodename]
        #frequency = 10 #nodeobject.getFrequency()  
        #voltage = 10 #nodeobject.getVoltage()  
        ...
        energy = _PN_HIGHEST* float(nodeobject.getExecTime())
...
def main():
   ...
   grouping(threshold,sorted_queue)
